...
// channels.hrr16 = slack.students.getChannelGroupOrDMByName('hrr16');
...
// channels.staff_helpdesk = slack.staff.getChannelGroupOrDMByName('help-desk');

// // Student Combo Channels
// channels.seniors = [channels.hrr14, channels.hrr15, channels.staff_srs];
// channels.juniors = [channels.hrr16, channels.staff_jrs];
// channels.students = channels.seniors.concat(channels.juniors);

// // everyone
// channels.everyone = [channels.general, channels.hrr11, channels.hrr12, channels.hrr13, channels.hrr14, channels.hrr15, channels.hrr16, channels.staff_delivery, channels.staff_general];
