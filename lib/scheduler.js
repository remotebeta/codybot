...
function scheduler() {
  ...
  // Scheduled Events
  events.push({
    when: new Date(2016, 01, 11, 15, 15, 0),
    who: [hrr12, hrr13],
    message: '<!channel> Town Hall is starting in 15 minutes. Post your questions now: https://townhall.makerpass.com/townhalls/hrr1213/deployment/FgnW8pvoqt6efzo4q'
  });

  events.push({
    when: new Date(2016, 01, 11, 15, 25, 0),
    who: [hrr12, hrr13],
    message: '<!channel> Town hall is starting in 5 minutes! https://zoom.us/j/685772​608'
  });

  events.push({
    when: new Date(2016, 01, 11, 15, 29, 0),
    who: [hrr12, hrr13],
