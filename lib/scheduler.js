...
function scheduler() {
  ...
  events.push({
    when: d.daily625pm,
    who: seniors,
    message: '<!channel> Greenfield Presentations in 5 minutes. https://zoom.us/j/525181230'
  });

  events.push({
    when: d.daily629pm,
    who: seniors,
    message: '<!channel> Greenfield Presentations in 1 minute. https://zoom.us/j/525181230'
  });
